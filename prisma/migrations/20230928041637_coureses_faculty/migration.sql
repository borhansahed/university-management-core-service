...
CREATE TABLE "course_faculties" (
    ...
    CONSTRAINT "course_faculties_pkey" PRIMARY KEY ("courseId","preRequisiteId")
);
...
-- AddForeignKey
ALTER TABLE "course_faculties" ADD CONSTRAINT "course_faculties_preRequisiteId_fkey" FOREIGN KEY ("preRequisiteId") REFERENCES "courses"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
